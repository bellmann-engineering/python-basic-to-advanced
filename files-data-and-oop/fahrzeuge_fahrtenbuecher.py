...
class Journey:
    def __init__(self, datum_as_string, startort, zielort, startkm, endkm, zweck, privat):
        ...
        # Kilometerstände zwingend als integer damit wir damit rechnen können
...
if __name__ == '__main__':
    ...
    if os.path.isdir(fahrtenbuch_folder):  # prüfen ob es das verzeichnis gibt
        # ermitteln der dateien im verzeichnis
        ...
        for fname in fahrtenbuecher_files:
            ...
            with open(filepath) as f:
                # dateiendung von dateinamen entfernen
                kennzeichen = os.path.splitext(fname)[0]
                for line in f:
                    lkws[kennzeichen].fahrtenbuch.append(
                        Journey.from_csv_line(line))   # an der richtigen stelle im dict
