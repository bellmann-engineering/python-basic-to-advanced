...
Für Baujahr und Erstzulassung kann wahlweise ``INT`` oder ``TEXT`` verwendet werden. Eine Date-Datentyp sieht SqLite nicht vor. Mehr zu Datentypen findest du hier:
...
4. Entwickle auf Basis des Programms der Vorwoche eine Version die ohne CSV dafür mit SQL arbeitet.
 ...
 Nun soll aus der Tabelle für Fahrtenbücher die Eintäge gelesen werden. Da wir keine Dateien mit Kennzeichen als Dateinamen mehr führen benötigt die Tabelle Fahrtenbuch eine Spalte "Kennzeichen" zur Zuordnung.
